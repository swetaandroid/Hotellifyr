...
import com.xongolab.hotellifyr.databinding.ActivityMostRelevantBinding
...
import com.xongolab.hotellifyr.view.adapter.MostRelevantVerticalAdapter
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale
import java.util.TimeZone

class MostRelevantActivity : CoreActivity() {
    private lateinit var binding: ActivityMostRelevantBinding
    private lateinit var imageAdapter: ImageAdapter
    private lateinit var adapter: MostRelevantVerticalAdapter

    private var hotelModel: HotelModel = HotelModel()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMostRelevantBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        if (intent.hasExtra(Constants.HOTELS)) {
            hotelModel =
                Gson().fromJson(intent.getStringExtra(Constants.HOTELS), HotelModel::class.java)
        }
        ...
        adapter = MostRelevantVerticalAdapter(this)
        binding.rvMostRelevantVertical.layoutManager = GridLayoutManager(this, 2)
        binding.rvMostRelevantVertical.adapter = adapter
        ...
        adapter.onItemClick = { item ->
            ...
            val intent = Intent(this@MostRelevantActivity, HotelDetailActivity::class.java)
